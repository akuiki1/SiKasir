...
<template>
    <div
        class="kg-auth flex min-h-svh w-full bg-[var(--kg-bg)] font-['Plus_Jakarta_Sans',sans-serif] text-[var(--kg-on)] antialiased"
    >
        <!-- ===== Panel kiri: form ===== -->
        <div
            class="flex w-full flex-col px-6 py-8 sm:px-10 lg:w-[46%] lg:px-14 xl:px-20"
        >
            <!-- Brand -->
            <Link
                :href="home()"
            ...
            <!-- Footer -->
            <p class="text-center text-xs text-[var(--kg-sec)] lg:text-left">
                © {{ new Date().getFullYear() }} Cemilan Mba Tutut · Hanya untuk
                admin &amp; kasir.
            </p>
        </div>
        ...
        <div
            class="relative hidden flex-col justify-between overflow-hidden p-12 text-white lg:flex lg:w-[54%] xl:p-16"
            style="
                background:
                    radial-gradient(
                            120% 120% at 85% 0%,
                    ...
                    linear-gradient(150deg, #7a2900 0%, #521800 60%, #3a1100 100%);
            "
        >
            <!-- Glow lembut -->
            <div
            ...
            <div class="relative z-10 my-auto w-full max-w-md">
                ...
                >
                    ...
                    >
                        <ShoppingBag class="h-3.5 w-3.5" /> Cemilan Mba Tutut
                    </span>
                    <h3
                    ...
                    <p class="mt-2 text-sm text-[#5d5e62]">
                        Aneka cemilan &amp; frozen food rumahan khas Barabai,
