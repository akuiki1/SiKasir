...
import { t as AppLogoIcon_default } from "./AppLogoIcon-Bjl50QHb.js";
...
var Welcome_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<span>Pesan Sekarang via WA</span></a><span class="text-xs font-semibold opacity-90 sm:text-sm">atau hubungi admin kami (0812-5474-4177)</span></div></div></div></div></section><footer class="dark:bg-neutral-980 border-t border-neutral-800 bg-neutral-900 pt-16 pb-8 text-neutral-300 transition-colors duration-300"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-2 gap-8 border-b border-neutral-800 pb-10 md:grid-cols-4 md:gap-12 md:pb-12"><div class="col-span-2 space-y-4 md:col-span-1"><div class="flex items-center gap-2"><div class="flex h-10 w-10 items-center justify-center">`);
			_push(ssrRenderComponent(AppLogoIcon_default, { class: "h-10 w-10" }, null, _parent));
...
//# sourceMappingURL=Welcome-TpNJHBkf.js.map